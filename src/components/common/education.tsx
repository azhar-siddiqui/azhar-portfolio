...
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card"; // standard alias
...
export default function Education() {
  return (
    <section className="relative bg-linear-to-b from-background to-background py-16 md:py-24 overflow-hidden">
      {/* Background accent */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        >
          <motion.div
            className="inline-flex items-center gap-3 px-6 py-3 bg-accent/40 backdrop-blur-md border border-primary/30 rounded-full mb-6"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 relative">
          ...
          <motion.div
            className="absolute top-1/2 left-1/2 -translate-x-1/2 w-full h-0.5 bg-linear-to-r from-transparent via-primary/30 to-transparent hidden md:block"
            initial={{ scaleX: 0 }}
          ...
          {education.map((edu, index) => (
            ...
            >
              ...
              >
                <motion.div
                  className="w-20 h-20 md:w-24 md:h-24 rounded-full bg-card border-2 border-primary/40 flex items-center justify-center shadow-lg shadow-primary/10"
                ...
                <motion.div
                  className="absolute inset-0 rounded-full bg-primary/20 blur-xl opacity-0 group-hover:opacity-70"
                  transition={{ duration: 0.5 }}
                />
              </motion.div>
              ...
              <Card
                className={cn(
                  "bg-card/60 backdrop-blur-md border-border/50 rounded-2xl overflow-hidden",
                  "hover:border-primary/50 hover:shadow-xl hover:shadow-primary/15 transition-all duration-300",
                  "pt-16 md:pt-20",
                )}
              >
                <CardHeader className="pb-4 border-b border-border/40">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center gap-2 mt-3 text-muted-foreground text-sm md:text-base">
